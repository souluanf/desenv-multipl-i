...
def test_find_user_by_id_not_found(client, mock_user_service):
    client.app.dependency_overrides[UserService] = lambda: mock_user_service
...
def test_delete_user_success(client, mock_user_repo):
...
def test_find_all_users(client, mock_user_repo, mock_user_service):
    client.app.dependency_overrides[UserService] = lambda: mock_user_service
    client.app.dependency_overrides[get_user_repo] = lambda: mock_user_repo
